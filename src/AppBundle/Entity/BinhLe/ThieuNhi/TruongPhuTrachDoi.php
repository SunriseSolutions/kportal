...
class TruongPhuTrachDoi {
	...
	/**
	 * @var DoiNhomGiaoLy
	 * @ORM\ManyToOne(targetEntity="AppBundle\Entity\BinhLe\ThieuNhi\DoiNhomGiaoLy", inversedBy="cacTruongPhuTrachDoi", cascade={"persist","merge"})
	...
	/**
	 * @var PhanBo
	 * @ORM\ManyToOne(targetEntity="AppBundle\Entity\BinhLe\ThieuNhi\PhanBo", inversedBy="cacTruongPhuTrachDoi", cascade={"persist","merge"})
