...
class HienDien {
	...
	/**
	 * @var PhanBo
	 * @ORM\ManyToOne(targetEntity="AppBundle\Entity\BinhLe\ThieuNhi\PhanBo", inversedBy="diemDanh")
	...
	/**
	 * @var PhanBo
	 * @ORM\ManyToOne(targetEntity="AppBundle\Entity\BinhLe\ThieuNhi\PhanBo", inversedBy="diemDanhThieuNhi")
	 * @ORM\JoinColumn(name="id_phan_bo", referencedColumnName="id", onDelete="CASCADE")
	 */
